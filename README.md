...
###4. DEMO
<<<<<<< HEAD
Trong phần này, tôi sẽ demo sử dụng SaltStack để cài đặt các gói cơ bản trước khi cài openstack trên 3 node.
Cấu hình 3 node minion như sau: <br>
Controller node:
...
Cả 3 node đều là máy ảo chạy Ubuntu server 14.04. Máy master là laptop cá nhân, sẽ sử dụng SaltStack để cài đặt cho 3 minion.<br>
Tất cả file cần thiết nằm trong thư mục state và pillar. <br>
...
>>>>>>> 969f5c4d9f22269a387c7c7d0146c41aca4245a6
